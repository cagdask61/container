...
export function Sidebar() {
    ...
    return (
        <>
            {!visible && (
                <button onClick={() => setVisible(true)} className="absolute top-0 left-0 mt-1 ml-1 rounded-lg z-50 p-2 flex items-center justify-center bg-white ease-in-out duration-300 hover:scale-105">
            ...
            <div className={"absolute z-50 top-0 w-72 h-full bg-black/90 border-r border-white/30 backdrop-blur ease-in-out duration-500" + (visible ? ' left-0' : ' -left-[33rem]')}>
