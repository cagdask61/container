...
export function GenerateContainer({ onSubmitHandler }: { onSubmitHandler?: () => void }) {
    ...
    return (
        <form method="post" onSubmit={handleSubmit} className="flex flex-col items-center gap-y-3">
            <div className="flex flex-col items-center justify-center gap-y-5 bg-white/5 p-5 rounded w-full">
                <span className="text-xl">Uzun Kısımlar</span>
                <div className="grid grid-cols-12 items-center justify-center gap-x-5">
                    <label htmlFor="firstLongSection" className="col-span-3">Sol Kısım</label>
                ...
                <div className="grid grid-cols-12 items-center justify-center gap-x-5">
                    <label htmlFor="secondLongSection" className="col-span-3">Sağ Kısım</label>
            ...
            <div className="flex flex-col items-center justify-center gap-y-5 bg-white/5 p-5 rounded w-full">
                ...
                <div className="grid grid-cols-12 items-center justify-center gap-x-5">
                    <label htmlFor="firstShortSection" className="col-span-3">Sol Kısım</label>
                ...
                <div className="grid grid-cols-12 items-center justify-center gap-x-5">
                    <label htmlFor="secondShortSection" className="col-span-3">Sağ Kısım</label>
